...
public class History extends android.support.v4.app.Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_history, container, false);


        // EVENT

        FragmentTransaction transaction = getFragmentManager().beginTransaction();
        transaction.replace(R.id.relativeLayoutHistoryFragmentcontainer, new HistoryList());
        transaction.commit();
